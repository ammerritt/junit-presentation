...
@ContextConfiguration( classes = { GeneralBusinessSpringConfig.class,
        MockTestBusinessSpringConfig.class },
...
public class PaymentProcessorTest
{
    ...
    {
        when( mockOrdersDao.selectById( 1 ) ).thenThrow( new ItemNotFoundException( "This is my test message." ) );
        paymentProcessor.processPayment( 1, CC_NUMBER_LUHN_VALID );
    }
}
