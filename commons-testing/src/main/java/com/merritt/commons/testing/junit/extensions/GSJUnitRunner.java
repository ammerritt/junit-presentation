...
public class GSJUnitRunner extends Suite
{
            ...
            if( dbUnitInsertClean != null )
            {
                try
                {
                    ...
                    if( !"".equals( dbUnitInsertClean.xmlDirectory() ) )
                    {
                        ...
                        {
                            DatabaseOperation.CLEAN_INSERT.execute( new DatabaseDataSourceConnection( getJndiDataSource( dbUnitInsertClean.dataSource() ) ), fxdsb.build( new FileInputStream( directory + File.separator + table ) ) );
                        }
                    }
                }
                catch( final Exception e )
     ...
     */
    public GSJUnitRunner( final Class<?> klass ) throws Throwable
    {
